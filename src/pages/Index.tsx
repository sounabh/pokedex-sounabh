    ...
    <div className="min-h-screen bg-gradient-pokedex p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Panel - Search */}
          <div className="bg-screen-bg screen-border rounded-2xl p-6 shadow-pokedex">
            <div className="bg-gradient-screen rounded-lg p-4 mb-4">
              <h2 className="text-xl font-digital font-bold text-screen-text mb-4 text-glow-green">
                POKEMON SEARCH
              </h2>
